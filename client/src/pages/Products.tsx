          ...
          <Tabs defaultValue="hunter" className="w-full">
            ...
            <TabsContent value="hunter" className="animate-in fade-in-50 duration-500">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                ...
                >
                  <img 
                    src="https://files.manuscdn.com/user_upload_by_module/session_file/310419663030557844/kfrKQeVcbpHBMAeQ.PNG" 
                    alt="Hunter Product" 
                ...
                >
                  ...
                  <div className="space-y-16 text-gray-600 leading-loose font-light">
                    ...
                    <div>
                      ...
                      <p className="mb-6">
                        私たちは、最初から「正解」を求めていません。むしろ、「こうしたら面白いんじゃないか？」「これとこれを組み合わせたら新しい価値が生まれるんじゃないか？」という仮説を立て、それを実際に試してみるプロセスそのものを楽しんでいます。
                      </p>
                      <p>
                        失敗することもありますが、それもまた一つのデータであり、次の挑戦への糧となります。この「仮説検証」のサイクルを高速で回し続けることこそが、私たちの強みであり、面白さでもあります。
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mb-6">
                        社名の「pH（ピーエイチ）」には、酸性とアルカリ性のバランスを示す指標のように、物事の「ちょうどいいバランス」を見つけたいという想いが込められています。
                      </p>
                      <p>
                        極端に振れるのではなく、状況や場に応じて最適なバランスを設計すること。私たちはその考え方を、プロダクト、イベント、情報発信に落とし込み、日常や体験の質を高める取り組みを行っています。
                      </p>
                    </div>
                  </div>
                </motion.div>
